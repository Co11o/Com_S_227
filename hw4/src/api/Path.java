...
public class Path implements Traversable {
	...
	if (updatedPointBIndex < 0) {
	    // we have reached the low end of the path, use the link to shift
	    // the points to
	    // the next path
	    ...
	    // we have reached the high end of the path, use the link to shift
	    // the points to
	    // the next path
	    ...
	    // we have not reached and endpoint, update the points from this
	    // path
