...
public class TracksPanel extends JPanel {
	...
	// AffineTransform a = AffineTransform.getRotateInstance(0.8, trainx +
	// 15,
	// trainy + 11);
	// g2.setTransform(a);
	g2.drawImage(trainEngineImage, (int) position.getPointB().getX() - 15, (int) position.getPointB().getY() - 11,
		null);
